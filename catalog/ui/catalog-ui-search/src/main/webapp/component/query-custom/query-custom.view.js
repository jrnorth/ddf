...
// TODO : Possibly Extend query-advanced
define([
    'marionette',
    'underscore',
    'jquery',
    ...
    return Marionette.LayoutView.extend({
        ...
        onBeforeShow: function(){
            ...
            if (this.model.get('formTemplate')) {
                this.setCqlFromFilter(this.model.get('formTemplate'));
            }
        ...
        setCqlFromFilter: function(formTemplate) {
            var filters = [formTemplate.root];
            var cql = this.queryAdvanced.currentView.setFilters(filters);
            if (cql) {
                this.model.set({
                    cql: this.queryAdvanced.currentView.transformToCql()
                });
